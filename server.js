...
const allowedOrigins = ['http://localhost:3000', 'http://127.0.0.1:5500', 'https://v-der0.github.io'];
app.use(cors({
  origin: function(origin, callback){
    if(!origin) return callback(null, true);  // Allow non-browser clients or tools like Postman
